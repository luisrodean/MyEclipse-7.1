...
public class CargaArchivoSofom extends CoreAction {
	/**
	 * 
	 */
	...
	private String archivoFileName;
		...
		public String getFiltroSofom() {
			return filtroSofom;
		}

		public void setFiltroSofom(String filtroSofom) {
			this.filtroSofom = filtroSofom;
		}
		...
		public String execute(){
			session.put("pos", "a4");	
			System.out.println("\n\n---> Entro carga archivo execute SOFOM");
			return "pantallaCargaArchivoSofom";
		}
		

		public String cargaArchivoSofom(){
			
			System.out.println("\n\n---> Entro a carga "+filtroSofom);
			CargaMasiva carga = new CargaMasiva(archivo, filtroSofom,"87");
			try{
				if(carga.CargarArchivo()){
					System.out.println("Carga de los archivos exitosa!!---->87");
