...
/*###############################################################################
# Nombre del Programa :  dhtmlxaccordion.js                                     #
# Autor               :  JOAQUIN MOJICA Q.										          				#
# Compania            :  WELLCOM S.A. DE C.V.                                   #
# Proyecto/Procliente :  P-02-0379-10                 	   FECHA:11/05/2011     #
# Descripcion General :	 Clase para el despliegue del menu      								#
#                                                                               #
...
function dhtmlXAccordion(baseId, skin) {
	...
	this.skinParams = { "standard":		{ "cell_height": 26, "cell_space": 1, "content_offset": 1 },
			    ...
			    "modern_red":	{ "cell_height": 29, "cell_space": 1, "content_offset": 1 }
	};
