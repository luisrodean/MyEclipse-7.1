/*###############################################################################
# Nombre del Programa :  dhtmlxtree.js                                          #
...
dhtmlXTreeObject.prototype._createDragNode=function(htmlObject,e){
    ...
    if (!obj.i_sel)
      ...
      var dragSpan=document.createElement('div');
            ...
            if (this._itim_dg)
                    for (var i=0; i<this._selected.length; i++)
                        text[i]="<table cellspacing='0' cellpadding='0'><tr><td><img width='16px' height='16px' src='"+this._getSrc(this._selected[i].span.parentNode.previousSibling.childNodes[0])+"'></td><td>"+this._selected[i].span.innerHTML+"</td></tr></table>";
            else
