       ...
       var windowReport;		
			...
			function llamarReportePDF()
			{
				...
				if($('#filtroCasFim').val()==""?0:1){
  						...
  						/*WELLCOM P-02-0271-13-SEER Inicia Marca de cambio  03/09/2014*/
  						var url ='servlet/ServletReporte?accion=rptTD&tiporpt=PDF&comentarios='+$('#comentarios').val()+'&filtroCasFim='+$('#filtroCasFim').val();
	...
	<body>
   		<div id= "tituloTab">Dictamen Centro Cambiario</div>
			...
			<div id="divImagen">
				...
				<br>
				<br>
				<label><VAR>REPORTE DE TRANSMISORES DE DINERO</VAR></label>
			</div>
  	</body>
</html>
