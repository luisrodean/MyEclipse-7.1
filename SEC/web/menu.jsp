...
<%
	...
	// Tratamos de obtener la posición establecida para el menú
	try
	{
	...
	<body onload="OnLoadMenu();">
	  	...
	  	function OnLoadMenu() 
		{
	    	...
	    	dhxAccord.closeItem("a9");
	    		    	...
	    		    	/** 
	    	***	Aquí le decimos que hacer en caso de q le den click a la pestaña Inicio
	    	**/    	        		 	
	    	...
	    	/** 
	    	***	Aquí le decimos que hacer en caso de q le den click a la pestaña Salir
	    	*
	    	...
	    	/** 
	    	*** El if se pone para que se abran las opciones del menú
	    	*** siempre y cuando no sea la opción inicio.
	    	**/
	    	...
	    	/** 
	    	***
	    	*** A partir de aquí se le dá formato a los submenús y 
