...
<html>
 	<head>
       ...
       <script type="text/javascript">	
			...
			{
				var valorFiltroCAtalogos = $("#filtroSofom").val();
	...
	<body>
   	 <div id= "tituloTab">Carga de Archivos SOFOM</div>
	  <div id="main">
   		<div id="divTblFiltros" class="divTblFiltros" >
   			
   			<div id="div_form">
		        <s:form id="formCargaArchivo" name="formCargaArchivo" enctype="multipart/form-data" method="POST" action="cargaArchivoSofom" >	        
					
						<s:select label="SOFOM: "  cssStyle="width: 250px;"
	       					name="filtroSofom"
	       					id="filtroSofom"
	       					headerKey="-1" headerValue="Selecciona un catálogo"
	       					...
	       					'tbl_ccc.csv':'Comité de Comunicación y Control',
	       					'tbl_ctrl.csv':'CTRL',
