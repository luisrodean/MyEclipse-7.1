...
<html>
 	<head>
       ...
       <script type="text/javascript">	
			...
			$(document).ready(function(){	
				...
				if(operResult!=null){
					$("#div_form").append(operResult);
					$( "#filtroResultado" ).hide();
				}
		...
		function validarUsuario(){
			...
			{
				/*var valorFiltroCAtalogos = $("#filtroCentrosCam").val();
	...
	<body>
   	 <div id= "tituloTab">Carga de Archivos Centros Cambiarios</div>
	  <div id="main">
   		<div id="divTblFiltros" class="divTblFiltros" >
   			
   			<div id="div_form">
		        <s:form id="formCargaArchivo" name="formCargaArchivo" enctype="multipart/form-data" method="POST" action="cargaArchivoCalificacion" >	        
